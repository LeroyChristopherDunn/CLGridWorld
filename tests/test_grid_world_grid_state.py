...
class TestGridWorldGridState(TestCase):
    ...
    def test_player_coords(self):
        ...
        self.assertEqual(GridWorldGridState.PLAYER, grid[player_coords])

        # alternative notations
        self.assertEqual(GridWorldGridState.PLAYER, grid[player_coords[0], player_coords[1]])
        self.assertEqual(GridWorldGridState.PLAYER, grid[player_coords[0]][player_coords[1]])
    ...
    def test_key_coords(self):
        ...
        self.assertEqual(GridWorldGridState.KEY, grid[key_coords])
    ...
    def test_lock_coords(self):
        ...
        self.assertEqual(GridWorldGridState.LOCK, grid[lock_coords])
